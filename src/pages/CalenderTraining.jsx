...
const EVENTS = {
  ...
  "2026-02-12": [
    { time: "2:00 PM", color: "bg-purple-500" },
  ],
  "2026-02-17": [
    { time: "11:00 AM", color: "bg-orange-500" },
  ],
};
    ...
    <div className="p-6 flex justify-center">
      ...
      <div className="w-full max-w-7xl space-y-6">
        ...
        <div>
          ...
          <p className="text-[#757575]">
            KPI tracking and employee appraisals
          </p>
        </div>
            ...
            {["Day","Week","Month"].map((v) => (
              <button
                ...
                className={`px-3 py-1.5 transition-colors ${
                  view === v ? "bg-red-500 text-white" : "bg-white text-gray-500 hover:bg-gray-50"
                }`}
              >
                {v}
              </button>
            ...
            return (
              <div
                ...
                className={`rounded-xl min-h-[102px] p-3.5 border ${
                  today_ ? "border-cyan-300 bg-cyan-50" : "border-gray-100"
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 w-full max-w-xs sm:max-w-sm">
        ...
        <div className="flex items-center gap-2 mb-5">
          ...
          <h2 className="text-base font-bold text-gray-900">Meeting Schedule</h2>
        </div>
