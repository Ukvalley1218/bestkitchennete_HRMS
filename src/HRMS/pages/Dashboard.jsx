...
const renderLegend = () => (
  <div className="flex items-center gap-4 mt-2 text-xs text-gray-500">
    <span className="flex items-center gap-1">
      <span
        className="inline-block w-5 border-t-2 border-red-500"
    ...
    <span className="flex items-center gap-1">
      <span
        className="inline-block w-5 border-t-2 border-yellow-400"
        style={{ borderStyle: "dashed" }}
      />
      leave
    </span>
    <span className="flex items-center gap-1">
      <span
        className="inline-block w-5 border-t-2 border-emerald-500"
        style={{ borderStyle: "dashed" }}
      />
      present
    </span>
...
const upcomingEvents = [
  {
    ...
    icon: (
      ...
      >
        <path
          d="M16.6654 17.5003V10.8337C16.6654 10.3916 16.4898 9.96771 16.1772 9.65515C15.8646 9.34259 15.4407 9.16699 14.9987 9.16699H4.9987C4.55667 9.16699 4.13275 9.34259 3.82019 9.65515C3.50763 9.96771 3.33203 10.3916 3.33203 10.8337V17.5003"
          stroke="#155DFC"
        ...
        />
        <path
          d="M3.33203 13.3333C3.33203 13.3333 3.7487 12.5 4.9987 12.5C6.2487 12.5 7.08203 14.1667 8.33203 14.1667C9.58203 14.1667 10.4154 12.5 11.6654 12.5C12.9154 12.5 13.7487 14.1667 14.9987 14.1667C16.2487 14.1667 16.6654 13.3333 16.6654 13.3333"
          stroke="#155DFC"
          stroke-width="1.66667"
          stroke-linecap="round"
          stroke-linejoin="round"
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M16.6667 6.66699H3.33333C2.8731 6.66699 2.5 7.04009 2.5 7.50033V9.16699C2.5 9.62723 2.8731 10.0003 3.33333 10.0003H16.6667C17.1269 10.0003 17.5 9.62723 17.5 9.16699V7.50033C17.5 7.04009 17.1269 6.66699 16.6667 6.66699Z"
          stroke="#9810FA"
          stroke-width="1.66667"
          stroke-linecap="round"
          stroke-linejoin="round"
...
const criticalAlerts = [
  {
    ...
    icon: (
      ...
      >
        <path
          d="M10 1.66699C8.35849 1.66699 6.78767 2.31927 5.62732 3.47962C4.46698 4.63996 3.8147 6.21078 3.8147 7.85232C3.8147 10.5294 5.2847 13.0663 7.16663 14.9982C8.02872 15.8828 9.00377 16.6694 10 17.3527C10.9962 16.6694 11.9713 15.8828 12.8334 14.9982C14.7153 13.0663 16.1853 10.5294 16.1853 7.85232C16.1853 6.21078 15.533 4.63996 14.3727 3.47962C13.2123 2.31927 11.6415 1.66699 10 1.66699Z"
          stroke="#DC2626"
          stroke-width="1.5"
          stroke-linecap="round"
          stroke-linejoin="round"
        />
        <path
          d="M10 10.0003C11.1046 10.0003 12 9.10489 12 8.00033C12 6.89576 11.1046 6.00033 10 6.00033C8.89543 6.00033 8 6.89576 8 8.00033C8 9.10489 8.89543 10.0003 10 10.0003Z"
          stroke="#DC2626"
          stroke-width="1.5"
          stroke-linecap="round"
          stroke-linejoin="round"
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M10 1.66699C5.40002 1.66699 1.66669 5.40032 1.66669 10.0003C1.66669 14.6003 5.40002 18.3337 10 18.3337C14.6 18.3337 18.3334 14.6003 18.3334 10.0003C18.3334 5.40032 14.6 1.66699 10 1.66699Z"
          stroke="#D97706"
          stroke-width="1.5"
          stroke-linecap="round"
          stroke-linejoin="round"
        />
        <path
          d="M10 5.00033V10.0003L13.3334 11.667"
          stroke="#D97706"
          stroke-width="1.5"
          stroke-linecap="round"
          stroke-linejoin="round"
...
const urgentNotifications = [
  {
    ...
    type: "leave",
    message:
      "Leave Request: Priya Sharma requested 3 days leave (Feb 15-17) - Pending Approval",
    priority: "high",
    time: "2 min ago",
  },
  {
    ...
    type: "expense",
    message:
      "Expense Claim: Amit Patel submitted ₹15,000 travel expense - Requires Review",
    priority: "medium",
    time: "15 min ago",
  },
  {
    ...
    type: "query",
    message:
      "Query: Rajesh Kumar (Production) has a PF withdrawal request pending for 5 days",
    priority: "high",
    time: "30 min ago",
  },
  {
    ...
    type: "attendance",
    message:
      "Attendance Issue: 3 employees marked absent without leave today - Action Required",
    priority: "urgent",
    time: "1 hr ago",
  },
  {
    ...
    type: "document",
    message:
      "Document Pending: Sneha Reddy's ID proof verification pending for onboarding",
    priority: "medium",
    time: "2 hrs ago",
  },
  {
    ...
    type: "grievance",
    message:
      "Grievance: Anonymous complaint received regarding shift scheduling - Needs Investigation",
    priority: "high",
    time: "3 hrs ago",
  },
  {
    ...
    type: "training",
    message:
      "Training Request: 5 employees requested access to new safety training module",
    priority: "low",
    time: "4 hrs ago",
  },
  {
    ...
    type: "promotion",
    message:
      "Promotion Review: Performance evaluation due for 3 eligible candidates this quarter",
    priority: "medium",
    time: "5 hrs ago",
  },
];
      ...
      <div className="relative bg-gradient-to-r from-red-600 via-red-500 to-red-600 rounded-xl mb-6 overflow-hidden shadow-lg">
        ...
        <div className="flex items-center relative">
          ...
          <div className="flex items-center gap-2 px-4 py-3 bg-red-700 flex-shrink-0 relative overflow-hidden">
            ...
            {/* Animated title */}
            <div className="relative">
              <span className="text-white font-bold text-sm whitespace-nowrap animate-glow tracking-wide">
                HR ALERTS
              </span>
              {/* Underline animation */}
          ...
          >
            <div
              ...
              style={{
                animation: isPaused ? "none" : "marquee 8s linear infinite",
              }}
            >
              {[...urgentNotifications, ...urgentNotifications].map(
                (notification, index) => (
                  <div
          ...
          >
            <div className="flex items-start justify-between mb-3">
              ...
              >
                ...
                >
                  <path
                    d="M12.1877 2.84375V6.09375C12.1877 6.20149 12.1449 6.30483 12.0687 6.38101C11.9926 6.4572 11.8892 6.5 11.7815 6.5C11.6737 6.5 11.5704 6.4572 11.4942 6.38101C11.418 6.30483 11.3752 6.20149 11.3752 6.09375V3.82434L7.1939 8.00617C7.15617 8.04394 7.11136 8.07391 7.06205 8.09435C7.01273 8.1148 6.95986 8.12532 6.90648 8.12532C6.85309 8.12532 6.80022 8.1148 6.75091 8.09435C6.70159 8.07391 6.65678 8.04394 6.61905 8.00617L4.87523 6.26184L1.5064 9.63117C1.43017 9.7074 1.32678 9.75023 1.21898 9.75023C1.11117 9.75023 1.00778 9.7074 0.931554 9.63117C0.855325 9.55494 0.8125 9.45155 0.8125 9.34375C0.8125 9.23595 0.855325 9.13256 0.931554 9.05633L4.5878 5.40008C4.62553 5.36231 4.67034 5.33234 4.71966 5.3119C4.76897 5.29145 4.82184 5.28093 4.87523 5.28093C4.92861 5.28093 4.98148 5.29145 5.0308 5.3119C5.08011 5.33234 5.12492 5.36231 5.16265 5.40008L6.90648 7.14441L10.8009 3.25H8.53148C8.42373 3.25 8.3204 3.2072 8.24421 3.13101C8.16803 3.05483 8.12523 2.95149 8.12523 2.84375C8.12523 2.73601 8.16803 2.63267 8.24421 2.55649C8.3204 2.4803 8.42373 2.4375 8.53148 2.4375H11.7815C11.8892 2.4375 11.9926 2.4803 12.0687 2.55649C12.1449 2.63267 12.1877 2.73601 12.1877 2.84375Z"
                    fill="#00A63E"
                  />
                </svg>
        ...
        {infoCards.map((card, i) => (
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              {/* label */}
              <p
                className={`text-[16px] font-semibold ${card.text || "text-[#82181A]"}`}
              >
                {card.label}
              </p>
            </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 w-full relative">
            ...
            <div className="absolute top-5 right-5 w-11 h-11 bg-red-500 rounded-full flex items-center justify-center shadow-lg z-10">
              ...
              >
                ...
                <path
                  d="M19 15l.9 2.7L22 18.5l-2.1.8L19 22l-.9-2.7L16 18.5l2.1-.8L19 15z"
                  opacity="0.85"
                />
              </svg>
            </div>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-base font-semibold text-emerald-800">
                  🎉 One Year Milestone Achievers
                </h3>
                <p className="text-xs text-emerald-600">
                  Celebrating employees completing their first year
                </p>
              </div>
            </div>
              ...
              {criticalAlerts.map((alert, i) => (
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span
                      className={`px-2 py-0.5 ${alert.badge} text-white text-xs font-medium rounded-full`}
                    >
