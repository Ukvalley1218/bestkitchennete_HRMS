  ...
  return (
    <div className="relative bg-white rounded-2xl p-5 flex flex-col gap-4 shadow-sm border border-gray-100 flex-1 min-w-[140px] overflow-hidden">
      ...
      <div className="flex items-start justify-between">
        {/* Icon box - light red background to match HRMS */}
        <div className="flex items-center justify-center rounded-xl" style={{ backgroundColor: '#FFE3E3', width: '40px', height: '40px', borderRadius: '12px' }}>
          <Icon size={20} style={{ color: '#A60000' }} strokeWidth={1.5} />
        </div>
